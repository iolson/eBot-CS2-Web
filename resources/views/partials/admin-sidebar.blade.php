<nav class="space-y-1">
    ...
    <a href="{{ url('/admin/startgg') }}"
       class="flex items-center gap-2 rounded-md px-3 py-2 text-sm {{ request()->is('admin/startgg*') ? 'bg-gray-700 text-white' : 'text-gray-400 hover:bg-gray-800 hover:text-white' }}">
        {{ __('start.gg') }}
    </a>
