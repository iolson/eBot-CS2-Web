<x-layouts.admin :title="__('Create Season')">
    <div class="space-y-6">
        {{-- Header --}}
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-xl font-bold text-white">{{ __('Create Season') }}</h1>
                <p class="mt-1 text-sm text-gray-400">{{ __('Add a new season or event.') }}</p>
            </div>
