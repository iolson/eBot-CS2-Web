...
abstract class MapsHeatmap
{
    ...
    public function buildMapDot($event_name, $round = null, $side = -1, $player_name = null, $sideName = 'all')
    {
        ...
        foreach ($points as $point) {
            ...
            $y = $point['event_y'];
            $this->calculPointToRes($x, $y);
            $pointToReturn[] = ['x' => $x, 'y' => $y, 'name' => $point['player_name'], 'team' => $point['player_team']];
        }
    ...
    public function buildTraceDead($round = null, $side = -1, $player_name = null, $sideName = 'all')
    {
        ...
        foreach ($points as $point) {
            ...
            $pointToReturn[] = ['x' => $x, 'y' => $y, 'name' => $point['player_name'], 'team' => $point['player_team'], 'x2' => $x2, 'y2' => $y2, 'attacker' => $point['attacker_name'], 'attacker_team' => $point['attacker_team']];
        }
