...
abstract class BasePlayersHeatmapFormFilter extends BaseFormFilterDoctrine
{
    public function setup()
    {
        ...
        $this->setValidators([
            ...
            'attacker_id' => new sfValidatorDoctrineChoice(['required' => false, 'model' => $this->getRelatedModelName('Killer'), 'column' => 'id']),
            ...
            'round_time' => new sfValidatorSchemaFilter('text', new sfValidatorInteger(['required' => false])),
