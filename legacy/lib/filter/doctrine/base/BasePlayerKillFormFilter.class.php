...
abstract class BasePlayerKillFormFilter extends BaseFormFilterDoctrine
{
    public function setup()
    {
        $this->setWidgets([
            ...
            'headshot' => new sfWidgetFormChoice(['choices' => ['' => 'yes or no', 1 => 'yes', 0 => 'no']]),
        ...
        $this->setValidators([
            ...
            'killer_id' => new sfValidatorDoctrineChoice(['required' => false, 'model' => $this->getRelatedModelName('Killer'), 'column' => 'id']),
            'killer_team' => new sfValidatorPass(['required' => false]),
            'killed_name' => new sfValidatorPass(['required' => false]),
            'killed_id' => new sfValidatorDoctrineChoice(['required' => false, 'model' => $this->getRelatedModelName('Killed'), 'column' => 'id']),
            'killed_team' => new sfValidatorPass(['required' => false]),
            'weapon' => new sfValidatorPass(['required' => false]),
            'headshot' => new sfValidatorChoice(['required' => false, 'choices' => ['', 1, 0]]),
