...
abstract class BaseMapsScoreFormFilter extends BaseFormFilterDoctrine
{
    public function setup()
    {
        ...
        $this->setValidators([
            ...
            'type_score' => new sfValidatorChoice(['required' => false, 'choices' => ['normal' => 'normal', 'ot' => 'ot']]),
            'score1_side1' => new sfValidatorSchemaFilter('text', new sfValidatorInteger(['required' => false])),
            'score1_side2' => new sfValidatorSchemaFilter('text', new sfValidatorInteger(['required' => false])),
            'score2_side1' => new sfValidatorSchemaFilter('text', new sfValidatorInteger(['required' => false])),
            'score2_side2' => new sfValidatorSchemaFilter('text', new sfValidatorInteger(['required' => false])),
