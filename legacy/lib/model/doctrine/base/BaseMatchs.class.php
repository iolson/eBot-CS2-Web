 ...
 * @property int $overtime_startmoney
 * @property int $overtime_max_round
 * @property bool $config_full_score
 * @property bool $config_ot
 * @property bool $config_streamer
 * @property bool $config_knife_round
 * @property bool $config_switch_auto
 * @property bool $config_auto_change_password
 * @property varchar $config_password
 * @property bool $config_heatmap
 * @property varchar $config_authkey
 * @property bool $enable
 * @property enum $map_selection_mode
 * @property bool $ingame_enable
 * @property int $current_map
 * @property bool $force_zoom_match
 * @property varchar $identifier_id
 * @property timestamp $startdate
 * @property bool $auto_start
 * @property int $auto_start_time
 ...
 * @method int getServerId() Returns the current record's "server_id" value
 * @method int getSeasonId() Returns the current record's "season_id" value
 * @method int getTeamA() Returns the current record's "team_a" value
 ...
 * @method int getTeamB() Returns the current record's "team_b" value
 ...
 * @method bool getIsPaused() Returns the current record's "is_paused" value
 ...
 * @method int getMaxRound() Returns the current record's "max_round" value
 * @method varchar getRules() Returns the current record's "rules" value
 * @method int getOvertimeStartmoney() Returns the current record's "overtime_startmoney" value
 * @method int getOvertimeMaxRound() Returns the current record's "overtime_max_round" value
 * @method bool getConfigFullScore() Returns the current record's "config_full_score" value
 * @method bool getConfigOt() Returns the current record's "config_ot" value
 * @method bool getConfigStreamer() Returns the current record's "config_streamer" value
 * @method bool getConfigKnifeRound() Returns the current record's "config_knife_round" value
 * @method bool getConfigSwitchAuto() Returns the current record's "config_switch_auto" value
 * @method bool getConfigAutoChangePassword() Returns the current record's "config_auto_change_password" value
 * @method varchar getConfigPassword() Returns the current record's "config_password" value
 * @method bool getConfigHeatmap() Returns the current record's "config_heatmap" value
 * @method varchar getConfigAuthkey() Returns the current record's "config_authkey" value
 * @method bool getEnable() Returns the current record's "enable" value
 * @method enum getMapSelectionMode() Returns the current record's "map_selection_mode" value
 * @method bool getIngameEnable() Returns the current record's "ingame_enable" value
 * @method int getCurrentMap() Returns the current record's "current_map" value
 * @method bool getForceZoomMatch() Returns the current record's "force_zoom_match" value
 * @method varchar getIdentifierId() Returns the current record's "identifier_id" value
 * @method timestamp getStartdate() Returns the current record's "startdate" value
 * @method bool getAutoStart() Returns the current record's "auto_start" value
 * @method int getAutoStartTime() Returns the current record's "auto_start_time" value
...
abstract class BaseMatchs extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        ...
        $this->hasColumn('ip', 'varchar', 50, [
            'type' => 'varchar',
            'length' => 50,
        ]);
        $this->hasColumn('server_id', 'integer', 20, [
            'type' => 'integer',
            'length' => 20,
        ]);
        ...
        $this->hasColumn('team_a', 'integer', 20, [
            'type' => 'integer',
            'length' => 20,
        ]);
        $this->hasColumn('team_a_flag', 'varchar', 2, [
            'type' => 'varchar',
            'length' => 2,
        ]);
        $this->hasColumn('team_a_name', 'varchar', 25, [
            'type' => 'varchar',
            'length' => 25,
        ]);
        $this->hasColumn('team_b', 'integer', 20, [
            'type' => 'integer',
            'length' => 20,
        ]);
        $this->hasColumn('team_b_flag', 'varchar', 2, [
            'type' => 'varchar',
            'length' => 2,
        ]);
        $this->hasColumn('team_b_name', 'varchar', 25, [
            'type' => 'varchar',
            'length' => 25,
        ]);
        $this->hasColumn('status', 'integer', 2, [
            'type' => 'integer',
            'length' => 2,
        ]);
        $this->hasColumn('is_paused', 'boolean', null, [
            'type' => 'boolean',
        ]);
        $this->hasColumn('score_a', 'integer', 5, [
            'type' => 'integer',
            'length' => 5,
        ]);
        $this->hasColumn('score_b', 'integer', 5, [
            'type' => 'integer',
            'length' => 5,
        ]);
        $this->hasColumn('max_round', 'integer', 3, [
            'type' => 'integer',
            'notnull' => true,
            'length' => 3,
        ]);
        $this->hasColumn('rules', 'varchar', 200, [
            'type' => 'varchar',
            'notnull' => true,
            'length' => 200,
        ]);
        $this->hasColumn('overtime_startmoney', 'integer', 5, [
            'type' => 'integer',
            'length' => 5,
        ]);
        $this->hasColumn('overtime_max_round', 'integer', 3, [
            'type' => 'integer',
            'length' => 3,
        ]);
        $this->hasColumn('config_full_score', 'boolean', null, [
            'type' => 'boolean',
        ]);
        $this->hasColumn('config_ot', 'boolean', null, [
            'type' => 'boolean',
        ]);
        $this->hasColumn('config_streamer', 'boolean', null, [
            'type' => 'boolean',
        ]);
        $this->hasColumn('config_knife_round', 'boolean', null, [
            'type' => 'boolean',
        ]);
        $this->hasColumn('config_switch_auto', 'boolean', null, [
            'type' => 'boolean',
        ]);
        $this->hasColumn('config_auto_change_password', 'boolean', null, [
            'type' => 'boolean',
        ]);
        $this->hasColumn('config_password', 'varchar', 50, [
            'type' => 'varchar',
            'length' => 50,
        ]);
        $this->hasColumn('config_heatmap', 'boolean', null, [
            'type' => 'boolean',
        ]);
        $this->hasColumn('config_authkey', 'varchar', 200, [
            'type' => 'varchar',
            'length' => 200,
        ]);
        $this->hasColumn('enable', 'boolean', null, [
            'type' => 'boolean',
        ]);
        $this->hasColumn('map_selection_mode', 'enum', null, [
            'type' => 'enum',
            'values' => [
                0 => 'bo2',
                1 => 'bo3_modea',
        ...
        $this->hasColumn('ingame_enable', 'boolean', null, [
            'type' => 'boolean',
        ]);
        $this->hasColumn('current_map', 'integer', 20, [
            'type' => 'integer',
            'length' => 20,
        ]);
        $this->hasColumn('force_zoom_match', 'boolean', null, [
            'type' => 'boolean',
        ]);
        $this->hasColumn('identifier_id', 'varchar', 100, [
            'type' => 'varchar',
            'length' => 100,
        ]);
        $this->hasColumn('startdate', 'timestamp', null, [
            'type' => 'timestamp',
        ]);
        $this->hasColumn('auto_start', 'boolean', null, [
            'type' => 'boolean',
        ]);
        $this->hasColumn('auto_start_time', 'integer', 3, [
            'type' => 'integer',
            'length' => 3,
        ]);
    }
    ...
    {
        parent::setUp();
        $this->hasOne('Servers as Server', [
            'local' => 'server_id',
            'foreign' => 'id',
            'onDelete' => 'SET NULL']);

        $this->hasOne('Teams as TeamA', [
            'local' => 'team_a',
            'foreign' => 'id',
            'onDelete' => 'SET NULL']);

        $this->hasOne('Teams as TeamB', [
            'local' => 'team_b',
            'foreign' => 'id',
            'onDelete' => 'SET NULL']);
