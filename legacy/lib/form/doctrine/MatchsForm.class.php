...
class MatchsForm extends BaseMatchsForm
{
    public function configure()
    {
        ...
        $password = ['frosch', 'gehen', 'rennen', 'gucken', 'fliegen', 'rasen', 'snobb', 'peter', 'wackel', 'dackel', 'gut', 'schlecht', 'win', 'loss', 'tragen',
        ...
        $supportedRoundFormats = ['15' => 'MR15', '12' => 'MR12', '9' => 'MR9', '5' => 'MR5', '3' => 'MR3'];
        ...
        $this->widgetSchema['max_round'] = new sfWidgetFormSelect(['choices' => $supportedRoundFormats, 'default' => $defaultRoundFormat]);
        $this->widgetSchema['overtime_max_round'] = new sfWidgetFormSelect(['choices' => ['5' => 'MR5', '3' => 'MR3'], 'default' => sfConfig::get('app_default_overtime_max_round')]);
        $this->widgetSchema['auto_start_time'] = new sfWidgetFormSelect(['choices' => ['5' => '05 Minutes Before Startdate', '10' => '10 Minutes Before Startdate', '15' => '15 Minutes Before Startdate', '30' => '30 Minutes Before Startdate']]);
        $this->widgetSchema['startdate'] = new sfWidgetFormInputText(['default' => date('d.m.Y H:i')], ['id' => 'match_startdate', 'style' => 'width:180px;']);
        ...
        $this->widgetSchema['team_a']->addOption('order_by', ['name', 'asc']);
        $this->widgetSchema['team_b']->addOption('method', 'getNameFlag');
        $this->widgetSchema['team_b']->addOption('order_by', ['name', 'asc']);
        ...
        $this->widgetSchema['team_a_flag'] = new sfWidgetFormSelect(['choices' => $aFlags]);
        $this->widgetSchema['team_b_flag'] = new sfWidgetFormSelect(['choices' => $aFlags]);

        $this->widgetSchema['map_selection_mode']->addOption('choices', ['normal' => 'BO1', 'bo3_modeb' => 'BO3']);
