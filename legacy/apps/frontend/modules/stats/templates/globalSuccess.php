            ...
            <li>
                <form style="margin:0; padding-top:5px;" method="post" action="<?php echo url_for('stats_filters'); ?>">
                    ...
                    <?php foreach ($filter as $widget) { ?>
                        <?php if ($widget->getName() != 'season_id') {
                            continue;
                        } ?>
                ...
                foreach ($matchs as $m) {
                    ...
                    foreach ($score as $p) {
                        ...
                        if (! @$scores[$p->getSteamid()]) {
                            $scores[$p->getSteamid()] = ['clutch' => 0, 'assist' => 0, 'kill' => 0, 'death' => 0, 'hs' => 0, 'bombe' => 0, 'defuse' => 0, 'point' => 0, 'tk' => 0, 'firstkill' => 0, 'name' => 'unknow', 'nbMatch' => 0];
                        }
...
<table id="tableScore" cellpadding="0" cellspacing="0" border="0" class="table table-striped table-condensed">
    ...
    <tbody>
        <?php
            ...
            <tr>
                <td><a href="<?php echo url_for('player_stats', ['id' => $k]); ?>"><?php echo $v['name']; ?></a></td>
