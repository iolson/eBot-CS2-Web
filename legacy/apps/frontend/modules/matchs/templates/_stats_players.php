...
<table class="table table-striped table-condensed" id="tablePlayers">
    ...
    <?php
    $total = ['kill' => 0, 'death' => 0, 'hs' => 0, 'bombe' => 0,
    ...
    <tbody>
        <?php foreach ($match->getMap()->getPlayer() as $player) { ?>
            ...
            <tr>
                ...
                <td><a href="<?php echo url_for('player_stats', ['id' => $player->getSteamid()]); ?>"><?php echo $player->getPseudo(); ?></a></td>
                <td <?php if ($player->getNbKill() == 0) {
                    echo 'class="muted" ';
                } ?> style="border-left: 1px solid #DDDDDD;"><?php echo $player->getNbKill(); ?></td>
                <td <?php if ($player->getAssist() == 0) {
                    echo 'class="muted" ';
                } ?>><?php echo $player->getAssist(); ?></td>
                <td <?php if ($player->getDeath() == 0) {
                    echo 'class="muted" ';
                } ?>><?php echo $player->getDeath(); ?></td>
                <td <?php if ($player->getDeath() == 0) {
                    echo 'class="muted" ';
                } ?>><?php if ($player->getDeath() == 0) {
                    echo $player->getNbKill();
                } else {
                    echo round($player->getNbKill() / $player->getDeath(), 2);
                } ?></td>
                <td <?php if ($player->getPoint() == 0) {
                    echo 'class="muted" ';
                } ?>><?php echo $player->getPoint(); ?></td>
                <td <?php if ($player->getHs() == 0) {
                    echo 'class="muted" ';
                } ?>><?php echo $player->getHs(); ?></td>
                <td><?php if ($player->getNbKill() == 0) {
                    echo '0';
                } else {
                    echo round($player->getHs() / $player->getNbKill(), 4) * 100;
                } ?>%</td>
                <td <?php if ($player->getDefuse() == 0) {
                    echo 'class="muted" ';
                } ?> style="border-left: 1px solid #DDDDDD;"><?php echo $player->getDefuse(); ?></td>
                <td <?php if ($player->getBombe() == 0) {
                    echo 'class="muted" ';
                } ?>><?php echo $player->getBombe(); ?></td>
                <td <?php if ($player->getTk() == 0) {
                    echo 'class="muted" ';
                } ?>><?php echo $player->getTk(); ?></td>
                <td <?php if ($player->getNb1() == 0) {
                    echo 'class="muted" ';
                } ?> style="border-left: 1px solid #DDDDDD;"><?php echo $player->getNb1(); ?></td>
                <td <?php if ($player->getNb2() == 0) {
                    echo 'class="muted" ';
                } ?>><?php echo $player->getNb2(); ?></td>
                <td <?php if ($player->getNb3() == 0) {
                    echo 'class="muted" ';
                } ?>><?php echo $player->getNb3(); ?></td>
                <td <?php if ($player->getNb4() == 0) {
                    echo 'class="muted" ';
                } ?>><?php echo $player->getNb4(); ?></td>
                <td <?php if ($player->getNb5() == 0) {
                    echo 'class="muted" ';
                } ?>><?php echo $player->getNb5(); ?></td>
                <td <?php if ($player->getNb1Kill() == 0) {
                    echo 'class="muted" ';
                } ?> style="border-left: 1px solid #DDDDDD;"><?php echo $player->getNb1Kill(); ?></td>
                <td <?php if ($player->getNb2Kill() == 0) {
                    echo 'class="muted" ';
                } ?>><?php echo $player->getNb2Kill(); ?></td>
                <td <?php if ($player->getNb3Kill() == 0) {
                    echo 'class="muted" ';
                } ?>><?php echo $player->getNb3Kill(); ?></td>
                <td <?php if ($player->getNb4Kill() == 0) {
                    echo 'class="muted" ';
                } ?>><?php echo $player->getNb4Kill(); ?></td>
                <td <?php if ($player->getNb5Kill() == 0) {
                    echo 'class="muted" ';
                } ?>><?php echo $player->getNb5Kill(); ?></td>
                <td <?php if ($player->getFirstkill() == 0) {
                    echo 'class="muted" ';
                } ?> style="border-left: 1px solid #DDDDDD;"><?php echo $player->getFirstkill(); ?></td>
                <td <?php if ($clutch == 0) {
                    echo 'class="muted" ';
                } ?>><?php echo $clutch; ?></td>
            </tr>
