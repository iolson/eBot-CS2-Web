...
?>
    ...
    <div class="tab-pane" id="stats-match">
        <?php include_partial('matchs/stats_match', ['match' => $match]); ?>
    </div>
    <div class="tab-pane" id="stats-players">
        <?php include_partial('matchs/stats_players', ['match' => $match]); ?>
    </div>
    <div class="tab-pane" id="stats-weapon">
        <?php include_partial('matchs/stats_weapon', ['match' => $match]); ?>
    </div>
    <!--
    <div class="tab-pane" id="livemap">
        <?php include_partial('matchs/livemap', ['match' => $match]); ?>
    </div>
    -->
    <div class="tab-pane" id="stats-killer-killed">
        <?php include_partial('matchs/stats_killer_killed', ['match' => $match]); ?>
    </div>
    <?php if (file_exists(sfConfig::get('app_log_match').'/match-'.$match->getId().'.html')) { ?>
    ...
    <?php if ($heatmap) { ?>
        <div class="tab-pane" id="heatmap">
            <?php include_partial('matchs/stats_heatmap', ['match' => $match, 'class_heatmap' => $class_heatmap]); ?>
        </div>
    <?php } ?>
    <div class="tab-pane" id="demos">
        <?php include_partial('matchs/stats_demos', ['match' => $match]); ?>
    </div>
    <div class="tab-pane" id="stats-entry-kills">
        <?php include_partial('matchs/stats_entry_kills', ['match' => $match]); ?>
    </div>
    <div class="tab-pane" id="stats-funny-facts">
        <?php include_partial('matchs/stats_funny_facts', ['match' => $match]); ?>
    </div>
</div>
