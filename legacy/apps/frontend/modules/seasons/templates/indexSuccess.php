        ...
        <tbody>
            <?php foreach ($current_seasons as $season) { ?>
                <tr class="season-selectable" data-id="<?php echo $season->getId(); ?>">
                    ...
                    <td style="vertical-align:middle;"><?php echo link_to("<button class='btn btn-inverse'>".__('View Matches').'</button>', 'seasons/select', ['query_string' => 'id='.$season->getId().'&site=inprogress']); ?></td>
                </tr>
                <tr>
                                        ...
                                        <?php if ($index >= 6) { ?>
                                            <tfoot>
                                                <tr><td colspan="6" style="text-align: center;">
                                                        <?php echo link_to(__('Display all Matches'), 'seasons/select', ['query_string' => 'id='.$season->getId().'&site=inprogress']); ?>
                                                </td></tr>
                                            </tfoot>
                                            <?php break; ?>
                                        <?php } ?>
        ...
        <tbody>
            <?php foreach ($inactive_seasons as $season) { ?>
                <tr class="season-selectable" data-id="<?php echo $season->getId(); ?>">
                    ...
                    <td style="vertical-align:middle;"><?php echo $season->getDateTimeObject('end')->format('d.m.Y'); ?></td>
                    <td style="vertical-align:middle;"><a href="<?php echo $season->getLink(); ?>" target="_blank"><?php echo $season->getLink(); ?></a></td>
                    <td style="vertical-align:middle;"><?php echo link_to("<button class='btn btn-inverse'>".__('View Matches').'</button>', 'seasons/select', ['query_string' => 'id='.$season->getId().'&site=archived']); ?></td>
                </tr>
                <tr>
                    <td colspan="7" style="padding:0; border:0;">
                        <div class="collapse" id="collapse-<?php echo $season->getId(); ?>"> <!--  -->
                                ...
                                <table class="table table-striped">
                                    ...
                                    <?php foreach ($matchs as $index => $match) { ?>
                                        <?php if ($index >= 6) { ?>
                                            <tfoot>
                                                <tr><td colspan="6" style="text-align: center;">
                                                    <?php echo link_to(__('Display all Matches'), 'seasons/select', ['query_string' => 'id='.$season->getId().'&site=archived']); ?>
                                                </td></tr>
                                            </tfoot>
                                            <?php break; ?>
                                        <?php } ?>
