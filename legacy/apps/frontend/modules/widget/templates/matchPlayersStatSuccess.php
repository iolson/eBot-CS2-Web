...
?>
    <tbody>
        <?php foreach ($players as $player) { ?>
            ...
            ?>
            <tr>
                <td><a target="_blank" href="<?php echo url_for('player_stats', ['id' => $player->getSteamid()]); ?>"><?php echo $player->getPseudo(); ?></a></td>
        ...
        if ($player->getDeath() == 0) {
            ...
            ?></td>
                ...
                <td style="border-left: 1px solid #DDDDDD;"><?php if ($result) { ?><img src="/images/kills/csgo/<?php echo $bestWeapon['weapon']; ?>.png"/> <?php echo $bestWeapon['nb']; ?> kills<?php } ?></td>
            </tr>
        <?php } ?>
    </tbody>
    <tfoot>
