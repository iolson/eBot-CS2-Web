        ...
        if ($request->isMethod('post')) {
            ...
            if ($this->form->isValid()) {
                ...
                $message = Swift_Message::newInstance()
                    ...
                    ->setBody($this->getPartial('sfGuardForgotPassword/send_request', ['user' => $this->form->user, 'forgot_password' => $forgotPassword]))
        ...
        if ($request->isMethod('post')) {
            ...
            if ($this->form->isValid()) {
                ...
                $message = Swift_Message::newInstance()
                    ...
                    ->setBody($this->getPartial('sfGuardForgotPassword/new_password', ['user' => $this->user, 'password' => $request['sf_guard_user']['password']]));
