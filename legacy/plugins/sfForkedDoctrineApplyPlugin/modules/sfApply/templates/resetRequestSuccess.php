...
a link permitting you to change your password if you wish.', [], 'sfForkedApply') ?>
</p>
<ul>
<?php echo $form ?>
<li class="submit_row">
<input type="submit" value="<?php echo __('Reset My Password', [], 'sfForkedApply') ?>">
<?php echo __('or', [], 'sfForkedApply') ?> 
